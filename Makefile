...
ge:             ge.o menu.o console.o getileset.o debug.o inifiles.o gelua.o globals.o inputs.o playsound.o
	$(CC) -o ge ge.o menu.o console.o getileset.o debug.o inifiles.o gelua.o globals.o inputs.o playsound.o $(LIBS)
